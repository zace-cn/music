...
public class CircleImageView extends ImageView {
	...
	public void setOnSeekChangeListener(OnSeekChangeListener mListener) {
...
//		this.angle = newAngle;
		...
		angle = (progress*1.0f/maxProgress*1.0f)*360.0f;
...
//	}
	...
	private void setCircleBar() {
		// circleBounds = new RectF(getWidth() / 2 - mDrawableRadius,
		// getHeight()
		// / 2 - mDrawableRadius, getWidth() / 2 + mDrawableRadius,
		// getHeight() / 2 + mDrawableRadius);

		circleBounds = new RectF(0 - barWidth / 2, 0 - barWidth / 2, getWidth()
				+ barWidth / 2, getHeight() + barWidth / 2);
	}
